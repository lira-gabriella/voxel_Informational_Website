      ...
      <section className="section why-section">
        <div className="container">
          ...
          <div className="balance-banner">
            <h3 className="balance-title">Protecting Livelihoods, Preserving Wildlife</h3>
            <p className="balance-text">
              Every lion that's safely deterred saves a farmer's livestock and that lion's life. Traditional retaliation kills protectors. Mara Guard enables peaceful resolution for both sides.
            </p>
            <div className="stats-row">
              <span><strong>100%</strong> Non-lethal deterrence</span>
              <span><strong>$0</strong> Post-deployment power cost</span>
            </div>
          </div>
        </div>
      </section>
